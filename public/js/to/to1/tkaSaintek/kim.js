...
function showResults(){
  ...
  //Auto Set Nilai
  var nilai1 = document.getElementsByName('kim');
...
const myQuestions = [
  {
    ...
    question: "1. <img src='https://im4ge.netlify.app/tka/st/kimia1/kim1.png' height='50%' width='60%'> ",
    answers: {
  ...
  {
    question: " 2. <img src='https://im4ge.netlify.app/tka/st/kimia1/kim2.png' height='35%' width='55%'>", 
    answers: {
      A: "(1), (2), dan (3)",
      B: "(1) dan (3)",
      C: "(2) dan (4)",
  ...
  {
    question:  "3.  <img src='https://im4ge.netlify.app/tka/st/kimia1/kim3.png' height='105%' width='100%'>",
    answers: {
      A: "3-metil-2-butanol",
      B: "2-metil-2-butanol",
      C: "3-metil-3-butanol",
  ...
  {
    question: "4.<img src='https://im4ge.netlify.app/tka/st/kimia1/kim4.png' height='130%' width='100%'>",
    answers: {
      A: "N2O5",
      B: "N2O3",
      C: "N2O",
  ...
  {
    question: "7.<img src='https://im4ge.netlify.app/tka/st/kimia1/kim7.png' height='60%' width='70%'>",
    answers: {
      A: "Pernyataan benar dan alasan benar serta saling berhubungan",
      B: "Pernyataan benar dan alasan benar tapi tidak berhubungan",
      C: "Pernyataan benar dan alasan salah",
  ...
  {
    question: "8.<img src='https://im4ge.netlify.app/tka/st/kimia1/kim8.png' height='70%' width='80%'>",
    answers: {
      A: "Pernyataan benar dan alasan benar serta saling berhubungan",
      B: "Pernyataan benar dan alasan benar tapi tidak berhubungan",
      C: "Pernyataan benar dan alasan salah",
  ...
  {
    question: "9.<img src='https://im4ge.netlify.app/tka/st/kimia1/kim9.png' height='90%' width='100%'>",
    answers: {
      A: "76",
      B: "104",
      C: "112",
  ...
  {
    question: "10.<img src='https://im4ge.netlify.app/tka/st/kimia1/kim10.png' height='70%' width='75%'>",
    answers: {
      A: "Pernyataan benar dan alasan benar serta saling berhubungan",
      B: "Pernyataan benar dan alasan benar tapi tidak berhubungan",
      C: "Pernyataan benar dan alasan salah",
  ...
  {
    question: "11.<img src='https://im4ge.netlify.app/tka/st/kimia1/kim11.png' height='20%' width='30%'>",
    answers: {
      A: "(1), (2), dan (3)",
      B: "(1) dan (3)",
      C: "(2) dan (4)",
  ...
  {
    question: "12. <img src='https://im4ge.netlify.app/tka/st/kimia1/kim12.png' height='85%' width='90%'>",
    answers: {
      A: "Pernyataan benar dan alasan benar serta saling berhubungan",
      B: "Pernyataan benar dan alasan benar tapi tidak berhubungan",
      C: "Pernyataan benar dan alasan salah",
  ...
  {
    question: "13. <img src='https://im4ge.netlify.app/tka/st/kimia1/kim13.png' height='80%' width='90%'>",
    answers: {
      A: "6 Liter",
      B: "12 Liter",
      C: "18 Liter",
  ...
  {
    question: "14. <img src='https://im4ge.netlify.app/tka/st/kimia1/kim14.png' height='110%' width='100%'>",
    answers: {
      A: "v menjadi 2v",
      B: "v menjadi 3v",
      C: "2v menjadi 3v",
  ...
  {
    question: "15. <img src='https://im4ge.netlify.app/tka/st/kimia1/km15.png' height='110%' width='100%'>",
    answers: {
      A: "5%",
      B: "40%",
      C: "45%",
