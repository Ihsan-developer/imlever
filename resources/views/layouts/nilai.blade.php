...
<head>
    ...
    <title>Try Out UTBK</title>
    <link rel="stylesheet" href="{{ asset('css/to.css') }}" />
    <!--AOS CSS-->
...
<body id="body">
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav-main">
        <div class="container">
            <img src="#" alt="" class="d-inline-block align-top" width="50" height="50" id="element-2" />
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    <!--<a class="nav-link" href="#" id="nav"></a>-->
    ...
    <!--End of Navbar-->
    @yield('content')
    <script src="{{ asset('js/to/to1.js') }}"></script>
