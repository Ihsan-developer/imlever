...
<head>
    ...
    <!--Judul-->
    <title>Imlever | Kejar PTN Impianmu bersama Imlever</title>
    <!--Logo-->
    <link rel="icon" href="images/imperior2.png" />
    <!-- CSRF Token -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link" href="#" id="nav">Tentang Kami</a>

                    <!--<a class="nav-link" href="{{ url('/top') }}" id="nav">Top Global Try Out</a>-->
                    <ul class="navbar-nav ml-auto">
                        <!-- Authentication Links -->
                        @guest
                        @if (Route::has('login'))

                        <a class="nav-link" href="{{ route('login') }}" id="nav">{{ __('Masuk') }}</a>

                        @endif

                        @if (Route::has('register'))
                        <li class="nav-item">
                            <a class="nav-link button daftar text-center" href="{{ route('register') }}" id="button">{{ __('Daftar') }}</a>
                        </li>
                        @endif
                        @else
                        ...
                        <div class="dropdown">
                            <a class="btn dropdown-toggle" id="nav" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                Halo, {{ Auth::user()->name }}
                            </a>

                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="{{ url('/dashboard') }}">{{ __('Dashboard') }}
                                    </a>
    ...
    <!-- Start Footer-->
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #002d7f">
        <div class="footer-2-3 container-xxl mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
                ...
                <div class="row gap-md-0 gap-3">
                    <div class="col-lg-3 col-md-6">
                        <div class="">
                            <div class="list-space">
                                <img src="images/imperior2.png" alt="" width="40px" height="40px" />
                            </div>
                  ...
                  <li class="list-space">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <nav class="list-unstyled">
                            <li class="list-space">
                                <a href="" class="list-menu">Try Out</a>
                            </li>
                            <li class="list-space">
                                <a href="https://www.freepnglogos.com/" target="_blank" class="list-menu">Atribution Logo</a>
                            </li>
                            <!-- <li class="list-space">
            ...
            ">
              ...
              ">
                ...
                justify-content-center
              ">
                        <p style="margin: 0">Copyright © 2021 Imlever Education</p>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <script>
        AOS.init();
        $("element-2").click("toggle-rotate-2");
    </script>
