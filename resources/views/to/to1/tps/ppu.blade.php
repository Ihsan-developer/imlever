...
<div class="text-center">
        <h3>TPS | Pengetahuan dan Pemahaman Umum</h3>
    </div>
    ...
    <div class="row" id="indikator">
       ...
       <!-- <div class="col-12 col-sm-2">
        ...
        <div class="col-12 col-sm-2"> 
            ...
            <form action="{{ route('ppu.store') }}" method="POST" >
                ...
                @csrf
                <ul class="list-group">
                 <input type="text"  name="ppu" readonly>
...
<script src="{{ asset('js/to/to1/tps/ppu.js') }}"></script>
@endsection